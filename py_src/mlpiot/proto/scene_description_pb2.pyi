...
class ObjectInScene(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"bounding_box",u"class_icon_url",u"class_name",u"color",u"confidence",u"payload",u"score"]) -> None: ...
    else:
...
class SceneDescription(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"annotated_image",u"input_image_id",u"metadata",u"objects",u"timestamp"]) -> None: ...
    else:
...
class SceneDescriptionArray(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metadata",u"objects",u"timestamp"]) -> None: ...
    else:
